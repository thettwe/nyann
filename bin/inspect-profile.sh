...
hook_blurb() {
  case "$1" in
    ...
    dotnet-format)        echo "dotnet format on staged C# files" ;;
    checkstyle)           echo "check Java code style and conventions" ;;
    dart-analyze)         echo "Dart static analysis on staged files" ;;
