...
@test "skill count matches the documented number (33)" {
...
@test "command file count matches the documented number (33 — one per skill)" {
...
@test "schema count matches the documented number (48)" {
