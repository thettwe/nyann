...
@test "skill count matches the documented number (32)" {
...
@test "command file count matches the documented number (32 — one per skill)" {
...
@test "schema count matches the documented number (47)" {
