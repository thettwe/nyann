...
@test "skill count matches the documented number (35)" {
...
@test "command file count matches the documented number (35 — one per skill)" {
...
@test "schema count matches the documented number (53)" {
